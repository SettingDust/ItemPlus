...
public class WrapperPlayClientBlockDig extends AbstractPacket
{
    ...
    public static class BlockSide extends IntEnum
    {
        ...
        private static final int[] xOffset = new int[]
        {
            0, 0, 0, 0, -1, 1
        };
        private static final int[] yOffset = new int[]
        {
            -1, 1, 0, 0, 0, 0
        };
        private static final int[] zOffset = new int[]
        {
            0, 0, -1, 1, 0, 0
        };
    ...
    /**
     * Retrieve the face being hit. See
     * {@link Packet0EPlayerDigging.BlockSide BlockSide}.
     *
